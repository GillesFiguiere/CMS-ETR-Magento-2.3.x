...
use ETransactions\etransactions\Model\Ui\EteppaybuttonsConfig;
...
final class EteppaybuttonsConfigProvider implements ConfigProviderInterface
{
    ...
    public function getCards()
    {
        ...
        $eteppaybuttonsConfig = $object_manager->get('ETransactions\etransactions\Model\Ui\EteppaybuttonsConfig');
        ...
        foreach ($types as $code) {
            $asset = $assetRepository->createAsset('ETransactions_etransactions::images/' . strtolower($code) . '.45.png');
